...
import { FileI } from '../models/categoria';
...
export class AnimeService {
  ...
  constructor(
    ...
    this.postsCollection = afs.collection<PostI>('anime');
  }

  public getAllPosts(): Observable<PostI[]> {

//    return this.afs.collection('anime')
//    .snapshotChanges()
//    .pipe(
//      map(actions =>
//        actions.map(a => {
...
//    );
  ...
  public getOnePost(id: PostI): Observable<PostI> {
    return this.afs.doc<PostI>(`anime/${id}`).valueChanges();
  }
